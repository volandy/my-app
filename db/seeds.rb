...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   u = User.create(:email => 'volandy@inbox.com', :password => 'ptnpnh1111', :password_confirmation => 'ptnpnh1111')
   ...
   Product.create(product_name: 'Korean Indasong Craft Paper', description: "Origami Paper Kit", price: 17.00, thumburl: 'http://funfamilycrafts.com/wp-content/uploads/2013/01/Chinese-New-Year-Fan.jpg', category_id: craft_supplies.id)
   Product.create(product_name: 'Handmade Gift Wrap', description: "Esoterica Handmade Supplies", price: 14.00, thumburl: 'http://www.pozible.com.au/uploads/01-2012/1327491042.jpg', category_id: craft_supplies.id)
   Product.create(product_name: 'Lollipot Flavor Kit', description: "Flavor Kit for Celebration Lollipops and Gifts", price: 21.00, thumburl: 'http://www.masterpiecesinc.com/Images/products/prodpuz/71419_BlowPops_1000puzzle.jpg', category_id: craft_supplies.id)
